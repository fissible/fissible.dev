...
- **Optional API tooling** — API Module adds OpenAPI contract validation, drift analysis, Request Lab, version scaffolding, and fault triage
...
| **[API Module](/station/api-pro/)** | Route browser, Request Lab, OpenAPI spec sync, version scaffolding, and fault triage |
...
- **[API Module](/station/api-pro/)** — inspect routes, sync OpenAPI specs, and triage faults
