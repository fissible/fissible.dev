...
Station can fold API operations and fault triage into the platform through API Module:

- **API operations** — [API Module](/station/api-pro/) provides contract validation, drift analysis, spec generation, Request Lab, and version scaffolding.
- **Exception triage** — API Module surfaces captured faults, deduplication, and resolution workflows.
...
[API Module](/station/api-pro/) adds:
